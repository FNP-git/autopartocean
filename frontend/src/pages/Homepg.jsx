          ...
          <div id="home">
            <div id="left" className="fade-up">
              ...
              <h5 className='para'>
                ...
                Drive with confidence, knowing you’re getting the best for less.
              </h5>
              <div id="cl-dmca">
                <a href="tel:+1-888-819-5651">
                  <button className='submit'>
                    <span className="submit-text">Call Now</span>
                  </button>
                </a>
                <a 
                  href="https://www.dmca.com/Protection/Status.aspx?ID=2adc4b2f-3d66-4b9b-9cf1-350789652c71&refurl=https://autopartocean.com/" 
                  target="_blank" 
